...
public class test3 {
	...
	static DecimalFormat ko28_df = new DecimalFormat("#,###,###,###,###"); //변수설정 숫자에 콤마 찍기
	static String[]ko28_items= {
	...
	static int[]ko28_price= {700,679,50,33,250,3,5,4,6,49800, //변수 설정 상품가격 
			420,600,50,500,60,20,100,400,40,90,
			2800,10,50,20,400,50,92,670,4};

	static int[]ko28_amount = {2,2,70,1,2,15,7,27,8,2, //변수 설정 상품량
			6,4,1,6,1,8,9,12,1,5,
			2,1,2,6,7,1,4,3,2};

	static boolean[] ko28_taxFree = { //면세 물품 설정  true-> 면세 물품
	...
	static int ko28_taxabletotal=0; //변수 초기화
	static int ko28_taxfreetotal=0; //변수 초기화
    static int ko28_totalSum=0; //변수 초기화
	static int ko28_totalQuantity=0; //변수 초기화
	
	static int itemcount=ko28_items.length;
	...
	public static void totalprint() {
		 ...
		 for(int ko28_i=0; ko28_i<ko28_items.length;ko28_i++){ //for 구문 0부터 상품의 길이까지 증가
			...
			ko28_totalQuantity += ko28_amount[ko28_i]; 
		}//품목의 수량을 더함
	...
	public static void timeprint(int i){
